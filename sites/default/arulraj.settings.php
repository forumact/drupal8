 ...
 * @endcode
 */
$settings['hash_salt'] = 'pKabNT68SMpXtJKbD39Y8MthuQLM7QUQ-gIvE-LfdtGw0cTbmfinZCwaFQHF4uRsz78V6cBghA';
...
$config_directories['sync'] = 'sites/default/files/config_fKiJ22xj6Nh17Ov_ssVsTqxwNHzJoRJg5S5IadnQKl0nf1pDeXS9al0w_obAriDf1zrQs_O3Ww/sync';
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
   //include $app_root . '/' . $site_path . '/settings.local.php';
}
